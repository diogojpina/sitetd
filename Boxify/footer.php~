			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						...
						<a href="http://www.usp.br" target="_left"><img src="img/logo-usp.jpg" width="78" height="78" alt="Universidade de São Paulo"></a>
		...
		<div class="overlay overlay-boxify">
			<nav>
				...
				<ul>
					<li><a href="#steps-intro"><i class="fa fa-desktop"></i>Etapas</a></li>
					<li><a href="#contact"><i class="fa fa-download"></i>Participe</a></li>
				</ul>
			</nav>
		</div>
