							...
							<figure>
								...
								<div class="caption-content">
									<a href="img/large/07.jpg" class="single_image">
										<i class="fa fa-search"></i><br>
										<p>Palestra sobre dívida técnica e ferramentas</p>
									</a>
								</div>
								</figcaption>
							</figure>
							...
							<figure>
								...
								<div class="caption-content">
									<a href="img/large/06.jpg" class="single_image">
										<i class="fa fa-search"></i><br>
										<p>Questionário de caracterização de equipe</p>
									</a>
								</div>
								</figcaption>
							</figure>
							...
							<figure>
								...
								<div class="caption-content">
									<a href="img/large/03.jpg" class="single_image">
										<i class="fa fa-search"></i><br>
										<p>Pagamento de itens de dívida técnica</p>
									</a>
								</div>
								</figcaption>
							</figure>
							...
							<figure>
								...
								<div class="caption-content">
									<a href="img/large/04.jpg" class="single_image">
										<i class="fa fa-search"></i><br>
										<p>Entrevista individual com cada programador</p>
									</a>
								</div>
								</figcaption>
							</figure>
